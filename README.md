...
workflows authenticate via the built-in `copilot-requests: write` permission. Use `--continuous-improvement` to also install
selected continuous improvement workflows.
