...
mkdir -p .github/workflows && curl -sL \
  https://raw.githubusercontent.com/elastic/ai-github-actions/v0/gh-agent-workflows/docs-drift/example.yml \
  -o .github/workflows/docs-drift.yml
```
...
- `create-issue` — file a docs drift report (max 1, auto-closes older reports)
