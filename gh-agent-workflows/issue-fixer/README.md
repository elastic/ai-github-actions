...
| `create-pr-allowed-files` | Glob pattern restricting which files the agent may modify in the PR (e.g. `src/**`); leave empty to rely on the default protected-files policy only | No | `""` |
