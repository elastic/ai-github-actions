...
Internal-only workflows (e.g., `gh-aw-upgrade-check.md`, `gh-aw-downstream-updates-needed.md`, `ci.yml`, `release.yml`) also live in `.github/workflows/`. See [gh-agent-workflows/DEVELOPING.md](gh-agent-workflows/DEVELOPING.md) for the full architecture.
