...
| Workflow | Trigger | Description |
| --- | --- | --- |
| [Dependency Review](gh-agent-workflows/dependency-review.md) | Dependabot/Renovate PRs | Analyze dependency updates across dependency types with conditional checks and risk assessment |
